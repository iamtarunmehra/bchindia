    ...
    return (
        <div className='w-full  '>
            ...
            <div className='max-w-[1170px] lg:py-[40px] py-[30px] mx-auto'>
                <h2 className='uppercase font-semibold text-red-600 text-center text-[33px] mb-5'>Enquiry</h2>
                <form className='bg-[#F3F3F3] p-5 max-w-[945px] mx-auto'>
                    <div className='grid grid-cols-2 gap-8 mb-3'>
                        <div>
                            <p>Product Name*</p>
                            <input type='text' className='bg-white focus:outline-none px-3 w-full py-[10px]' />
                        </div>
                        <div>
                            <p>Your Name*</p>
                            <input type='text' className='bg-white focus:outline-none px-3 w-full py-[10px]' />
                    ...
                    <div className='mb-3'>
                        <p>Address</p>
                        <textarea className='w-full min-h-[100px] bg-white focus:outline-none'></textarea>
                    </div>
