...
export default function ContactUs() {
    ...
    return (
        <div className='w-[100%] py-[40px]'>
            <div className="max-w-[1170px] mx-auto border-t pt-12 border-red-600 grid md:grid-cols-2 gap-12">
                ...
                <div className='w-[100%]'>
                    ...
                    <form action="">
                        <div className='grid md:grid-cols-2 mb-7 gap-10'>
                            <input className='border-[1px] placeholder:text-gray-400 rounded-[5px] border-gray-500 py-[10px] px-4' type="text" placeholder='NAME*' />
                            <input className='border-[1px] placeholder:text-gray-400 rounded-[5px] border-gray-500 py-[10px] px-4' type="text" placeholder="COMPANY NAME" />
                        </div>
                        <div className='grid md:grid-cols-2 my-7 gap-10'>
                            <input className='border-[1px] placeholder:text-gray-400 rounded-[5px] border-gray-500 py-[10px] px-4' type="text" placeholder='YOUR BUSINESS EMAIL*' />
                            <input className='border-[1px] placeholder:text-gray-400 rounded-[5px] border-gray-500 py-[10px] px-4' type="text" placeholder="PHONE NUMBER*" />
                        </div>
                        <div className='grid md:grid-cols-2 my-7 gap-10'>
                            <input className='border-[1px] placeholder:text-gray-400 rounded-[5px] border-gray-500 py-[10px] px-4' type="text" placeholder='CITY*' />
